...
class ProductsService():
    ...
    def createTableAuto(self, path, nameTable,id, varcharValue, numberValue):
        columnsName = self.getColumnsNames(path)
        listStringColumns = self.products.createTable(columnsName)
        create_table_sql = f'''
